<template>
  <section class="bg-white px-6 lg:py-12">
    <div class="container flex flex-col justify-center py-24 md:p-8">
      <h2>
      ...
      <div class="space-y-4">
        <details class="w-full border rounded-lg">
          <summary class="px-4 py-6 focus:outline-none focus-visible:ring-violet-400">
