<template>
  <div class="bg-sky-900 px-4 pt-6">
    <div class="container divide-y-2 divide-slate-500">
      <div class="py-8 text-white gap-8 lg:gap-16 grid lg:grid-cols-3">
        <div class="flex flex-col pb-4 gap-y-3">
          ...
          <p class="text-white inline-block">
            Ruko Pulogadung Trade Center (PTC) Blok 8A No. 7 Jl. Raya Bekasi KM.
            21 Rawa Terate, Cakung, Jakarta Timur
          </p>
          <a href="mailto:info@glosmed.co.id" class="w-fit">info@glosmed.co.id</a>
          <a href="tel:+6281586018007" class="w-fit">+62 815 8601 8007</a>
        </div>
        <div class="grid grid-cols-2 py-4">
          <div class="">
            <h4 class="mb-5">Perusahaan</h4>
            <a
              v-for="item in company"
              :key="item.name"
              :href="item.href"
              class="text-white flex w-fit py-2 hover:text-secondary"
            >{{ item.name }}</a>
          </div>
          <div class="">
        ...
        <div class="py-4 space-y-3">
          ...
          <p class="text-white">
            Dapatkan notifikasi perihal produk dan berita terbaru kami.
          </p>
          <div class="flex justify-start items-center">
            <form action="" class="mr-4 w-full">
              <input
                type="text"
                name="email"
      ...
      <div class="flex flex-col lg:flex-row justify-between py-6 text-white">
        <div
          class="flex justify-center items-center space-x-4 mb-2 lg:mb-0 lg:order-1"
        >
          <!-- Instagram -->
          <a
          ...
          <!-- YouTube -->
          <a
            href="https://www.youtube.com/channel/UC2lPYJOko_LGonATYytdrow"
            target="_blank"
            class="hover:text-secondary"
          >
            <svg
        ...
        <div class="text-center">
          © 2022 Global Selaras Medika, All Right Reserved
        </div>
      </div>
    </div>
  </div>
